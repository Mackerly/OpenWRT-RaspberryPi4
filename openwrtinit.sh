...
# samba autoshare
wget -O ./files/etc/hotplug.d/block/20-smb https://github.com/upx/upx/releases/download/v3.96/upx-3.96-amd64_linux.tar.xz

# blockdevice automount
wget -O ./files/etc/hotplug.d/block/11-mount https://github.com/upx/upx/releases/download/v3.96/upx-3.96-amd64_linux.tar.xz
